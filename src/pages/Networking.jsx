            ...
            {[
              {
                title: "Networking",
                description:
                  "Divisi Networking UKM-IT Cybernetix adalah ruang bagi anggota yang tertarik untuk mendalami konsep jaringan komputer dan keamanan siber. Divisi ini dirancang untuk memberikan pengetahuan dan keterampilan praktis terkait pengelolaan, pemeliharaan, serta keamanan jaringan, yang sangat penting di dunia teknologi saat ini.",
                image: networking,
              },
            ].map((item, index) => (
              <div
